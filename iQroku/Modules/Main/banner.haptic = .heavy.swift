...
class BannerView: UIView {
    init() {
        ...
        let uncView = teamView(image: #imageLiteral(resourceName: "img-next-arrow"), record: "27-0", onLeft: true)
        let dukeView = teamView(image: #imageLiteral(resourceName: "img-next-arrow"), record: "18-9", onLeft: false)
